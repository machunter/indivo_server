...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SleepStats'
        db.create_table('indivo_sleepstats', (
            ('fact_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['indivo.Fact'], unique=True, primary_key=True)),
            ('awakenings', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('awakeningsZqPoints', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('bedTime', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('grouping', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('morningFeel', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('riseTime', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('startDate', self.gf('django.db.models.fields.DateField')(blank=True)),
            ('timeInDeep', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('timeInDeepPercentage', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('timeInDeepZqPoints', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('timeInLight', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('timeInLightPercentage', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('timeInLightZqPoints', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('timeInRem', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('timeInRemPercentage', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('timeInRemZqPoints', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('timeInWake', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('timeInWakePercentage', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('timeInWakeZqPoints', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('timeToZ', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('totalZ', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('totalZZqPoints', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('zq', self.gf('django.db.models.fields.IntegerField')(blank=True)),
        ))
        db.send_create_signal('indivo', ['SleepStats'])


    def backwards(self, orm):
        # Deleting model 'SleepStats'
        db.delete_table('indivo_sleepstats')
    ...
    models = {
        ...
        'indivo.sleepstats': {
            'Meta': {'object_name': 'SleepStats', '_ormbases': ['indivo.Fact']},
            'awakenings': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'awakeningsZqPoints': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'bedTime': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'fact_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['indivo.Fact']", 'unique': 'True', 'primary_key': 'True'}),
            'grouping': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            'morningFeel': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'riseTime': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'startDate': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
            'timeInDeep': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'timeInDeepPercentage': ('django.db.models.fields.FloatField', [], {'blank': 'True'}),
            'timeInDeepZqPoints': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'timeInLight': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'timeInLightPercentage': ('django.db.models.fields.FloatField', [], {'blank': 'True'}),
            'timeInLightZqPoints': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'timeInRem': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'timeInRemPercentage': ('django.db.models.fields.FloatField', [], {'blank': 'True'}),
            'timeInRemZqPoints': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'timeInWake': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'timeInWakePercentage': ('django.db.models.fields.FloatField', [], {'blank': 'True'}),
            'timeInWakeZqPoints': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'timeToZ': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'totalZ': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'totalZZqPoints': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'zq': ('django.db.models.fields.IntegerField', [], {'blank': 'True'})
        },
        'indivo.statusname': {
